...
echo "
  <div class='mx-auto gradasi-toska p-3' style='max-width: 500px; min-height:100vh'>
    ...
    <div class='mb3 tengah'>
      <a target=_blank class='btn btn-success w-100 mt2' href='cetak_pmb.php'>Cetak PDF PMB</a>
    </div>
    <hr>
    <div class='mb3 tengah'>
      ...
      <a target=_blank class='btn btn-primary w-100 mt2' href='https://chat.whatsapp.com/ZZZ'>Gabung ke Whatsapp Grup</a>
    </div>
  </div>
