...
if (1) {
  # ============================================================
  # AUTOMATIC ADD GRUP KELAS
  # ============================================================
  alert("Grup Kelas otomatis ditambahkan untuk seluruh semester pada tiap prodi yang [Jumlah Rombel] nya sudah ditentukan.", 'info');
  include 'auto_add_all_kelas.php';
  // } else {
