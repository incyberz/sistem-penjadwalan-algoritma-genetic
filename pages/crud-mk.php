  ...
  # ============================================================
  $items = '';
  $sub_select = 'SELECT COUNT(1) FROM tb_mk WHERE id_prodi=a.id AND semester =';
...
ORDER BY a.jenjang, a.nama";
  ...
  <div class='gradasi-toska f12 p1'>
    <h2 class='bold darkblue f12 tengah'>PILIHAN MK</h2>
    <div id=navs class=''>
      $nav_prodi
      $nav_semester
    </div>
...
ORDER BY a.id_prodi, a.semester, a.nama";
  $q = mysqli_query($cn, $s) or die(mysqli_error($cn));
