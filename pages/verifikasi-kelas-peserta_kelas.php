...
if ($kelas['count_peserta']) {
  $status_syarat = "<b>Jumlah Peserta:</b> $kelas[count_peserta] Mhs <span class=btn_aksi id=blok_manage_peserta__toggle>$img_edit</span>";
    ...
    <div class='row'>
      <div class=col-6>
        <form method=post class='wadah gradasi-kuning mt2'>
          ...
          <div class='mb2'>$checks_mhs</div>
          
          <button class='btn btn-info' name=btn_assign>Assign</button>
        </form>
      </div>
      <div class=col-6>
        <form method=post class='wadah gradasi-kuning mt2'>
        ...
        <form method=post class=' wadah gradasi-kuning mt2'>
          <div><b>Add Mhs semester $kelas[semester] (angkatan $angkatan):</b></div>
          <div class='mt2 mb2'>
